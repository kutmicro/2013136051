...
boolean br4;
///////////////////////////////
boolean ls1 = false;   // 조도센서1의 현재상태(눌림 or 안눌림)
boolean ls2 = false;   // 이하, 위와 유사
boolean ls3 = false;
boolean ls4 = false;

boolean lr1;           // 조도센서1 상태 확인용 입력값 임시저장용
