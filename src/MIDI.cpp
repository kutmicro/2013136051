...
int c = 60; //버튼1의  note(음계)  가령 "도"  0~127까지 지정가능 (정확한 음계 설정은 MIDI관련정보참고)
int d = 62; //버튼2의  note(음계)  가령 "레"
int e = 64; //버튼3의  note(음계)  가령 "미"
int f = 65; //버튼4의  note(음계)  가령 "파"
int g = 67; //버튼5의  note(음계)  가령 "솔"
int a = 69; //버튼6의  note(음계)  가령 "라"
int b = 71; //버튼7의  note(음계)  가령 "시"
